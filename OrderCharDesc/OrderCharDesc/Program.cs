...
namespace OrderCharDesc
{
    class Program
    {
        ...
        {
            /*
            Given a string of characters, order the characters by descinding frequency of appearance. Return a string.
            ...
            Console.WriteLine("Given a string of characters, order the characters by descinding frequency of appearance.\n");

            string unSorted = "abbccccddddde";
            string sorted = Util.OrderCharDesc(unSorted);
            Console.WriteLine($"The string [{unSorted}] sorted by descinding character frequency is [{sorted}].\n");
